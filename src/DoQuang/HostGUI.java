...
public class HostGUI extends javax.swing.JFrame implements ServerChatListener {
    ...
    InetAddress CurIPAdress(){
        try {
            ...
            System.out.println("Ten may host: " + ip.getHostName());
            System.out.println("Dia chi IP: " + ip.getHostAddress());
            return ip;
        } catch (UnknownHostException e) {
            System.err.println("Khong the lay dia chi IP: " + e.getMessage());
            return null;
        }
    }
    ...
    private void AppLoop(){
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                lblConns.setText(Integer.toString(server.getConnectedClients()));
            }
